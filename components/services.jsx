  ...
  return (
    <section className="relative w-full bg-black text-white py-20 px-6 md:px-12">
      ...
      <motion.img
        ...
        alt="Airtable"
        className="absolute top-10 right-12 w-12 md:w-16"
        initial={{ y: 0 }}
        animate={{ y: [0, -15, 0] }}
      ...
      <motion.img
        ...
        alt="OpenAI"
        className="absolute top-24 left-1/2 w-12 md:w-16"
        initial={{ y: 0 }}
        animate={{ y: [0, 20, 0] }}
      ...
      <motion.img
        src="/icons/miro.png"
        alt="Miro"
        className="absolute bottom-20 left-12 w-12 md:w-16"
        initial={{ y: 0 }}
        animate={{ y: [0, -25, 0] }}
        ...
        {services.map((service, i) => (
          ...
          >
            <Card className="bg-transparent border-0 shadow-none text-white">
              <CardHeader>
                <span className="text-gray-400 text-xl mb-2">{service.number}</span>
